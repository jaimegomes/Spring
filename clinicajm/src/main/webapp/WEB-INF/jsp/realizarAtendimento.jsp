...
<tiles:insertDefinition name="template">
	<tiles:putAttribute name="corpo">
		...
		<springform:form method="post"
			action="${pageContext.request.contextPath}/consulta/atender.do"
			modelAttribute="consulta">
			<div style="width: 500px;">
				Especialidade: ${consulta.medico.nome} <br /> Paciente:
				${consulta.paciente.nome} <br /> Data da Consulta:
				<fmt:formatDate value="${consulta.dataConsulta}"
			...
			<div style="width: 500px;">
				...
				<div class="form-group">
					...
					<springform:textarea id="sintomas" path="sintomas"
						readonly="${consulta.dataAtendimento != null}"
				...
				<div class="form-group">
					...
					<springform:textarea id="receita" path="receita"
						readonly="${consulta.dataAtendimento != null}"
						cssClass="form-control" />
