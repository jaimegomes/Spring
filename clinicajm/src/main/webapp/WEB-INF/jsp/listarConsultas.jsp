		...
		<script type="text/javascript">
										...
										$
												.each(
														...
														function(i, consulta) {
															...
															dataAtendimento = consulta.dataAtendimento == null ? null
																	: new Date(
																			consulta.dataAtendimento);
															$(
																	"#tabela_consultas tbody")
																	.append(
																			"<tr>"
																					+ "<td>"
																					...
																					+ "</td>"
																					+ "<td>"
																					+ formataData(dataConsulta)
																					+ "</td>"
																					+ "<td>"
																					+ formataData(dataAtendimento)
																					+ "</td>"
																					+ "<td>"
																					+ "<a href=${pageContext.request.contextPath}/consulta/detalharConsulta.do?idConsulta="
																					+ consulta.id
																					+ ">"
			...
			function formataData(d) {
				...
				return (dia < 10 ? '0' + dia : dia) + '/'
						+ (mes < 10 ? '0' + mes : mes) + '/' + d.getFullYear()
						+ ' ' + (hora < 10 ? '0' + hora : hora) + ':'
